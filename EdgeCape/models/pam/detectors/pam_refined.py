...
class PoseAnythingModelRefined(BasePose):
    ...
    def forward_test(self,
        ...
        output, initial_proposals, similarity_map, _ = self.predict(img_s, target_s, target_weight_s, img_q, img_metas, target_coarse_s=target_coarse_s)
    ...
    def predict(self,
        ...
        output = self.refine_head(target_s_ori, output, coarse_s, mask_s)
