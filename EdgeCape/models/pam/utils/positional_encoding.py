...
class PAM_SinePositionalEncoding(BaseModule):
    ...
    def __init__(self,
                 ...
                 offset=0.,
                 init_cfg=None):
        super(PAM_SinePositionalEncoding, self).__init__(init_cfg)
        if normalize:
...
@POSITIONAL_ENCODING.register_module()
class PAM_LearnedPositionalEncoding(BaseModule):
    ...
    def __init__(self,
        ...
        super(PAM_LearnedPositionalEncoding, self).__init__(init_cfg)
